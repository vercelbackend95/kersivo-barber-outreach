...
| Google | OAuth/IdP processing under Google; GA4 active under analytics consent (Admin event/user retention **2 months** / **2 months**, reset **OFF** — configured/verified in GA4 Admin **25 Sep 2026**; provider propagation follow-up pending after stated ~24h application window; distinct from browser `_ga` cookie TTL); Google Ads inactive / dormant; controller-side Gmail outreach mailbox (A15) — contract/transfer **CLOSED — CURRENT USE VERIFIED** (CDPA accepted 25 Sep 2026); mailbox residual copies remain provider-controlled | **PROVIDER CONTROLLED** residuals for mailbox copies. GA4 direct transfer: **UK adequacy — TRA NOT REQUIRED** ([vendor-evidence/google-analytics.md](./vendor-evidence/google-analytics.md)). Ads transfer reopen only if Ads reactivated. A15 Gmail tooling distinct from A11/A12/A14 |
| Notion | Controller-side Lead Master / suppression residual (A15) — contract/transfer **CLOSED — CURRENT USE VERIFIED** | **PROVIDER CONTROLLED** residual copies after KERSIVO deletion/minimisation; operator enforces § I policy |
| Meta / Instagram | Controller-side ordinary DM residual where used (A15) — contract/role **CLOSED — CURRENT USE VERIFIED** (ordinary DMs only) | **PROVIDER CONTROLLED** platform residual under Meta/Instagram terms |
...
| 2026-09-25 | **Phase 6B:** Notion / Google Workspace-Gmail / Meta-Instagram ordinary DM contract/role marked **CLOSED — CURRENT USE VERIFIED** (CDPA accepted 25 Sep 2026). Residual copies remain provider-controlled; § I operator retention unchanged. Substantive baseline unchanged (`6ef76ab…`). |
