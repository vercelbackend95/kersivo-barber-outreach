...
7. Obtain/confirm **signed current vendor DPAs** and record the **exact** UK safeguard for remaining providers (enabled Twilio/Slack/Google/Stripe).
8. Confirm production enablement of **Twilio**, **Slack**, **Google OAuth** (OpenAI Admin AI and Sentry Production enablement **CONFIRMED**).
9. Confirm **Slack** workspace/account contracting entity from actual terms (do not invent).
