...
| 6 | Onboarding form + preview + Approve & launch audit | `PARTIAL` | product, ops, copy | WP-J, WP-L | P1 | Copy/Terms §6 aligned (21 Jul 2026): materials, billing vs materials, 1–2 weeks wording, preview + Approve and launch, approval metadata, DNS after approve. **Produktowy audit trail** (kto/kiedy/wersja/go-live) nadal `MISSING` (WP-J). | |
...
| 34 | Dozwolone claimy marketingowe | `PARTIAL` | copy | WP-L | P0* | SMS included claim włączony (owner). Reszta §34 (booking deposits, RBAC unlimited users, scheduled email cron) nadal zależy od WP-A/B/D/E | |
...
9. **§6 Onboarding / launch:** copy w Terms opisuje materiały, billing od zakupu, timeline 1–2 weeks after materials, preview + Approve and launch, DNS po approve. Public copy **nie** opisuje przyszłego hostingu preview ani mechaniki przycisku. Audit trail zatwierdzenia = WP-J (nadal do zbudowania).
...
| Email reminders (jako scheduled, nie tylko confirm) | WP-D |
