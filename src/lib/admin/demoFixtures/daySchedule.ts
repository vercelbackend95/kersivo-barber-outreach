...
export const DEMO_DAY_SEEDS: DemoDaySeed[] = [
  ...
  { id: 'demo-day-02', fullName: 'Amelia Clarke', email: 'amelia.clarke@example.com', barberId: J, barberName: 'Jamie Reed', serviceId: DEMO_SERVICE_IDS.premiumHaircut, serviceName: 'Premium haircut', hour: 10, minute: 0, durationMin: 45, pricePence: 4500 },
  ...
  { id: 'demo-day-11', fullName: 'Isla Morgan', email: 'isla.morgan@example.com', barberId: A, barberName: 'Alex Morgan', serviceId: DEMO_SERVICE_IDS.qualityBeardTrim, serviceName: 'Quality beard trim', hour: 9, minute: 45, durationMin: 15, pricePence: 1500 },
  ...
  { id: 'demo-day-15', fullName: 'Ruby Shaw', email: 'ruby.shaw@example.com', barberId: A, barberName: 'Alex Morgan', serviceId: DEMO_SERVICE_IDS.premiumBeardTrim, serviceName: 'Premium beard trim', hour: 13, minute: 15, durationMin: 25, pricePence: 3000 },
  ...
  { id: 'demo-day-18', fullName: 'Grace Turner', email: 'grace.turner@example.com', barberId: A, barberName: 'Alex Morgan', serviceId: DEMO_SERVICE_IDS.longerBeardTrim, serviceName: 'Longer beard trim', hour: 17, minute: 45, durationMin: 35, pricePence: 4000 },
  // Sam Brooks (9)
  ...
  { id: 'demo-day-20', fullName: 'Maya Brooks', email: 'maya.brooks@example.com', barberId: S, barberName: 'Sam Brooks', serviceId: DEMO_SERVICE_IDS.qualityHaircut, serviceName: 'Quality haircut', hour: 9, minute: 30, durationMin: 30, pricePence: 3500 },
  { id: 'demo-day-21', fullName: 'Freya Hughes', email: 'freya.hughes@example.com', barberId: S, barberName: 'Sam Brooks', serviceId: DEMO_SERVICE_IDS.longerHaircut, serviceName: 'Longer haircut', hour: 10, minute: 15, durationMin: 60, pricePence: 6500, tags: ['VIP'] },
  { id: 'demo-day-22', fullName: 'Sophie Lane', email: 'sophie.lane@example.com', barberId: S, barberName: 'Sam Brooks', serviceId: DEMO_SERVICE_IDS.premiumBeardTrim, serviceName: 'Premium beard trim', hour: 11, minute: 30, durationMin: 25, pricePence: 3000 },
  ...
  { id: 'demo-day-29', fullName: 'Ivy Patel', email: 'ivy.patel@example.com', barberId: M, barberName: 'Marcus Bell', serviceId: DEMO_SERVICE_IDS.shortBackAndSides, serviceName: 'Short back and sides clipper', hour: 9, minute: 30, durationMin: 25, pricePence: 3000 },
  ...
  { id: 'demo-day-31', fullName: 'Zara Quinn', email: 'zara.quinn@example.com', barberId: M, barberName: 'Marcus Bell', serviceId: DEMO_SERVICE_IDS.headShave, serviceName: 'Head shave', hour: 11, minute: 30, durationMin: 20, pricePence: 2500 },
  ...
  { id: 'demo-day-33', fullName: 'Eliza Shaw', email: 'eliza.shaw@example.com', barberId: M, barberName: 'Marcus Bell', serviceId: DEMO_SERVICE_IDS.longerBeardTrim, serviceName: 'Longer beard trim', hour: 13, minute: 15, durationMin: 35, pricePence: 4000 },
