...
const BRAND_FACTS: KnowledgeSection = {
  ...
  body: [
    ...
    ONBOARDING_TIMELINE_CLAIM,
    PREVIEW_LAUNCH_CLAIM,
    'Owner flow: once KERSIVO delivers a preview, it appears under Preview website in the dashboard. Owner reviews content/booking/team/hours, then clicks Approve & launch. Approval records who, when, site version, and go-live date. DNS is switched only after approval (OPS).',
    'Do not describe internal preview hosting URL format, OPS API endpoint, or iframe delivery mechanics in customer-facing answers.',
    MISSING_OPTIONAL_MATERIALS_CLAIM,
    MISSING_CRITICAL_MATERIALS_CLAIM,
    NO_FAKE_STOCK_CLAIM,
