 ...
 */
const SCHEMA_MARKER = `saas-subscription-v1|sms-reminders-enabled-v1|booking-deposits-v1|legal-acceptance-v1|site-launch-preview-v1|email-reminders-v1|${Object.keys(SetupDepositStatus).sort().join('|')}`;
