 ...
 */
const SCHEMA_MARKER = `saas-subscription-v3-grace-suspend|sms-reminders-enabled-v1|booking-deposits-v1|legal-acceptance-v1|site-launch-preview-v1|email-reminders-v1|astro7-dotenv-v1|${Object.keys(SetupDepositStatus).sort().join('|')}`;
