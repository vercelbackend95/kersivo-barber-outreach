  ...
  recommendations: [
    {
      ...
      mustExclude: ['cal-prod-long-shampoo', 'cal-prod-beard-oil', 'cal-prod-gift-set', 'cal-prod-kids-gel'],
      ...
      pairAssertions: [
        ...
        {
          productId: 'cal-prod-kids-gel',
          expected: 'REJECTED',
          allowedRejectionCodes: ['AUDIENCE_MISMATCH_CHILD_ONLY'],
        },
      ],
    ...
    },
    {
      ...
      pairAssertions: [
        ...
        { productId: 'cal-prod-multi-balm', expected: 'ELIGIBLE' },
        {
          productId: 'cal-prod-kids-gel',
          expected: 'REJECTED',
          allowedRejectionCodes: ['AUDIENCE_MISMATCH_CHILD_ONLY'],
    ...
    {
      id: 'kids-cut-kids-gel',
      serviceId: 'cal-svc-kids-cut',
      relevantProductIds: [
        'cal-prod-kids-gel',
        'cal-prod-matte-clay',
        'cal-prod-pomade',
      ...
      mustInclude: ['cal-prod-kids-gel'],
      pairAssertions: [
        { productId: 'cal-prod-kids-gel', expected: 'ELIGIBLE' },
        { productId: 'cal-prod-matte-clay', expected: 'ELIGIBLE' },
      ],
    },
    {
      ...
      mustInclude: ['cal-prod-multi-balm', 'cal-prod-pomade'],
      requireHairAndBeardCoverage: true,
    },
    {
