...
export const LampBackground: React.FC = () => {
  ...
  const spotlightCore = toHexAlpha(0.38 * breathe);
  const spotlightMid = toHexAlpha(0.22 * breathe);
  const ambientAlpha = toHexAlpha(0.1 * breathe);
  const vignette = interpolate(frame % 180, [0, 90, 180], [0.18, 0.26, 0.18]);
